...
CUDA_VISIBLE_DEVICES=0 python detecter.py --model ./models/model_best.pth --rp ./detect_results/real-dispnet3 --filelist ./lists/real_release.list --filepath /home/vradmin/dispflownet-release/data
