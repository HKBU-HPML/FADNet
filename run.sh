...
python main.py --cuda --outf ./models/girl-models-dispCSRes-finetune-crop-3nd --lr 0.0001 --logFile girl-train-dispCSRes-finetune-crop-3nd.log --showFreq 1 --devices 0,1,2,3 --trainlist ./lists/girl05.list --vallist ./lists/girl03_TEST.list --model ./models/girl-models-dispCSRes-finetune-crop-2nd/dispS_epoch_98.pth --startEpoch 1 --datapath /home/datasets/imagenet/dispnet/virtual --batchSize 8 --endEpoch 100
