...
# dispnetCSR(small kernel size)+ Relu + girl02
#python main.py --cuda --outf ./models/girl02-models-dispCSR-ks --lr 1e-3 --logFile girl02-models-dispCSR-ks.log --showFreq 1 --devices 0,1,2,3 --trainlist lists/girl02_TRAIN.list --vallist lists/girl02_TEST.list --startEpoch 0 --endEpoch 100 --datapath data/girl02
python main.py --cuda --outf /data3/models/cropfrom2048-models-dispCSR-1nd --lr 1e-4 --logFile cropfrom2048-models-dispCSRes-1nd.log --showFreq 1 --devices 0,1,2,3 --trainlist lists/exclude_1536_noir_TRAIN.list --vallist lists/exclude_1536_noir_TEST.list --model /home/vradmin/pytorch-dispnet/models/cleandata-models-dispCSRes-exp/model_best.pth --startEpoch 0 --endEpoch 60 --datapath /data3/virtual3-1024 --batchSize 16
