...
class MobileDispNetRes(nn.Module):
    ...
    def forward(self, input1, input2, get_feature=False):
        ...
        pr6 = pr6_res + F.interpolate(base_flow, scale_factor=2**(-6)) # 1-1
        ...
        pr5 = pr5_res + F.interpolate(base_flow, scale_factor=2**(-5)) # 1-1
        ...
        pr4 = pr4_res + F.interpolate(base_flow, scale_factor=2**(-4))
        ...
        pr3 = pr3_res + F.interpolate(base_flow, scale_factor=2**(-3))
        ...
        pr2 = pr2_res + F.interpolate(base_flow, scale_factor=2**(-2))
        ...
        pr1 = pr1_res + F.interpolate(base_flow, scale_factor=0.5)
