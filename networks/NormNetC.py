...
class NormNetC(nn.Module):

    def __init__(self, input_channel=6):
        super(NormNetC, self).__init__()
        ...
        self.pred_flow6 = predict_flow(1024, 4)
        ...
        '''
        self.iconv5 = nn.ConvTranspose2d(1028, 512, 3, 1, 1)
        self.iconv4 = nn.ConvTranspose2d(772, 256, 3, 1, 1)
        self.iconv3 = nn.ConvTranspose2d(388, 128, 3, 1, 1)
        self.iconv2 = nn.ConvTranspose2d(196, 64, 3, 1, 1)
        self.iconv1 = nn.ConvTranspose2d(100, 32, 3, 1, 1)
        self.iconv0 = nn.ConvTranspose2d(20+self.input_channel, 16, 3, 1, 1)
